...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "7B5GmUfcwscffRBieJTxj9iyX", consumerSecret: "2dtOWukdBlLD2k49cMyFOxKrd6L7sdCdFFjRlfvn7UozAiWgh2")
    var loginSuccess: (() -> ())?
